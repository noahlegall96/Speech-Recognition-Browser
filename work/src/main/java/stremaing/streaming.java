...
public class streaming {
  ...
  private static final Logger logger = Logger.getLogger(streaming.class.getName());
  ...
  public streaming() throws IOException{
	    String host = null;
	    Integer port = null;
	    ...
	    options.addOption(
	        Option.builder()
	            ...
	            .build());
	    try {
	      CommandLine line = parser.parse(options,null);
	    ...
	    this.bytesPerBuffer = samplingRate * BYTES_PER_SAMPLE / 10; 
   ...
   */
  public streaming(ManagedChannel channel, int samplingRate)
      throws IOException {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ManagedChannel channel = createChannel(host, port);
    streaming client = new streaming(channel, sampling);
    try {
      client.recognize();
    } finally {
